...
Nós queremos contribuir para Gatsby ser divertido e agradável para todos. Se você está interessado em participar da comunidade Gatsby, contribuições vão muito além de pull requests e commits. Nós estamos muito felizes em receber uma variedade de outras contribuições incluindo as seguintes:

- Blogging, falar sobre ou criar tutoriais sobre alguma das muitas funcionalidades do Gatbsy. Mencionar [@gatsbyjs no Twitter](https://twitter.com/gatsbyjs) and/or email marcy [at] gatsbyjs [dot] com so we can give pointers and tips (if you want them 😄) and help you spread the word. Please add your blog posts and videos of talks to our [Awesome Gatsby](/docs/awesome-gatsby-resources/) page.
